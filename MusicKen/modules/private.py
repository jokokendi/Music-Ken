...
@Client.on_message(filters.private & filters.incoming & filters.command & filters.group & ~ filters.edited(['help']))
...
def map(pos):
    ...
    return button
@Client.on_message(filters.group & ~ filters.edited & filters.command("help"))
def _help(client, message):
    client.send_message(chat_id = message.chat.id,
        text = tr.HELP_MSG[1],
        parse_mode="markdown",
