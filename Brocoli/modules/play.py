...
from Brocoli.config import ARQ_API_KEY
from Brocoli.config import BOT_NAME as bn
from Brocoli.config import DURATION_LIMIT
from Brocoli.config import UPDATES_CHANNEL as updateschannel, SUPPORT_GROUP
from Brocoli.config import que
from Brocoli.function.admins import admins as a
from Brocoli.helpers.admins import get_administrators
from Brocoli.helpers.channelmusic import get_chat_id
from Brocoli.helpers.errors import DurationLimitError
from Brocoli.helpers.decorators import errors
from Brocoli.helpers.decorators import authorized_users_only
from Brocoli.helpers.filters import command, other_filters
from Brocoli.helpers.gets import get_file_name
from Brocoli.services.callsmusic import callsmusic, queues
...
from Brocoli.services.downloaders import youtube
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/c1715dedc403ebf896e57.png"
        ...
        keyboard = InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("💌 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{updateschannel}"), InlineKeyboardButton("🥦", url="https://t.me/sntaiboss")],
